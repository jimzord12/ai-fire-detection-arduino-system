...
2.  Run the helper script directly from the WSL share:
    ```powershell
    \\wsl.localhost\Ubuntu-24.04\home\jimzord12\projects\ai-fire-detection-arduino-system\scripts\connect-arduino\connect-arduino.ps1
    ```
...
- **Collect Data:** `./scripts/automated_data_collection/automated_data_collection.sh ...`
- **Upload Data:** `./scripts/upload_to_edge_impulse/upload_to_edge_impulse.sh ...`
