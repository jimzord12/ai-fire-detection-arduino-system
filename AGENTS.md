...
arduino-cli compile --fqbn arduino:renesas_uno:arduino_uno_r4_wifi sketches/fireDetectionSystemV2.ino

# Upload sketch to Arduino
arduino-cli upload -p /dev/ttyACM0 --fqbn arduino:renesas_uno:arduino_uno_r4_wifi sketches/fireDetectionSystemV2.ino
...
./scripts/automated_data_collection/automated_data_collection.sh <label> <num_samples> <duration> [scenario]

# Upload data to Edge Impulse
./scripts/upload_to_edge_impulse/upload_to_edge_impulse.sh <label> [scenario]

# Environment check
./scripts/check-edge-impulse-env/check-edge-impulse-env.sh
```
...
### File Structure
- `sketches/`: Arduino firmware (`.ino` files)
...
- Check `DAY-TO-DAY-SETUP.md` for daily workflow procedures
- Refer to `super-guide.md` for detailed hardware and software documentation
