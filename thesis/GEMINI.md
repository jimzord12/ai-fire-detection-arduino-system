...
For figure placement descriptions, see [IMAGE_DESCRIPTIONS.md](assets/figures/IMAGE_DESCRIPTIONS.md).

For table proposals and placements, see [TABLE_PROPOSALS.md](typst/tables/TABLE_PROPOSALS.md).
