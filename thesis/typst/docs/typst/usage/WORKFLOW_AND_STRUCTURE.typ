...
- Compile once:
  - `typst compile thesis/typst/main.typ /tmp/thesis_preview.pdf`
...
- Periodically merge curated entries into the global bibliography:
  - `thesis/typst/bibliography.bib`
