...
#figure(
  table(
    columns: (1fr, 1.2fr, 1fr, 0.8fr, 1.5fr),
    inset: 10pt,
    align: horizon,
  ...
  caption: [Summary of Selected Multi-Sensor Suite Specifications],
) <table-sensor-specs>
