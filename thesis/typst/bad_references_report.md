...
Based on the [Academic Review Report](academic_review_report.md), this document identifies "bad" (non-peer-reviewed/hobbyist) references currently used in the thesis and provides the context needed to find appropriate academic replacements from high-impact journals (e.g., *IEEE Sensors*, *Information Fusion*, *ACM Transactions on Embedded Systems*).
