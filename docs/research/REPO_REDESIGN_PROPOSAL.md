...
- **Vague Naming**: Directory names like `docs/research/` and `contexts/` don't clearly describe their purpose.
...
- Create a `docs/` directory to house everything currently in `docs/research/`, `contexts/`, and the large markdown files in root.
- Move `docs/guides/DAY-TO-DAY-SETUP.md` and `docs/guides/super-guide.md` to `docs/guides/`.
...
3. Update `docs/guides/super-guide.md` and `docs/guides/DAY-TO-DAY-SETUP.md` internal links.
