...
### Documentation
*   `docs/guides/super-guide.md`: **The comprehensive manual.** Contains wiring diagrams, setup steps, code explanations, and thesis resources. Read this first.
*   `READEME.md`: Project introduction and component inventory.
*   `docs/guides/DAY-TO-DAY-SETUP.md`: Quick reference for daily development tasks.
...
1.  Upload `firmware/fireDetectionSystemV2.ino` to Arduino.
...
1.  Upload `firmware/fireDetectionSystemV2.ino`.
2.  Run `logger/logger.py` (or wrapper scripts) to save data to local CSVs.
3.  Run `tools/integration/upload_to_edge_impulse.sh` to push files to the cloud.

### 3. Deployment
1.  Train model in Edge Impulse Studio.
2.  Export as **Arduino Library**.
3.  Install library in Arduino IDE.
4.  Create/Upload inference sketch (see `docs/guides/super-guide.md` section 8).
